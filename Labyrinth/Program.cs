...
namespace Labyrinth
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                TypeWriter("Hello " + playerName + ", would you like the game to keep typing like this? (yes/no)");
            ...
            TypeWriter("Thanks " + playerName + "! The game will start now!");
            //starts the game
        ...
        static void StartGame(string playerName)
        {
            ...
            while (isContinuePlaying == true)
            {
                ...
                if (isAfterPath == true)
                {
                    ...
                    TypeWriter("Where will you go next, " + playerName + "?");
                }
                else
                {
                    TypeWriter("Which way will you go, " + playerName + "?");
                }
        ...
        static void Left(string playerName)
        {
                ...
                if (choice2 == "yes")
                {
                    ...
                    while (choice3Made == false)
                    {
                        ...
                        if (choice3 == "yes")
                        {
                            ...
                            TypeWriter("\"Hello\", you say. \"I am " + playerName + "\"");
                            TypeWriter("...");
        ...
        static void Forward(string playerName)
        {
        ...
        static void Right(string playerName)
        {
